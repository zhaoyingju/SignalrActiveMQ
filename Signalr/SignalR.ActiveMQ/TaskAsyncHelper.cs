...
// Copied directly from the Signalr project
...
namespace Microsoft.AspNet.SignalR
{
    internal static class TaskAsyncHelper
    {
        ...
        private static void AttachFaultedContinuation<TTask>(TTask task, Action<AggregateException, object> handler,
            object state) where TTask : Task
        {
            task.ContinueWithPreservedCulture(innerTask => { ExecuteOnFaulted(handler, state, innerTask.Exception); },
